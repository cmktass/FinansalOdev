...
public class ProfilKategorilendirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profil_kategorilendir);
        dersler=findViewById(R.id.katspinner);
        konular=findViewById(R.id.katspinner2);
        sec=findViewById(R.id.katbutton);
        konuDersSecimi();
        sec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ProfilFragment.profilDers=secilenDers;
                ProfilFragment.profilDersKonu=secilenKonu;
                System.out.println(secilenDers);
                System.out.println(secilenKonu);
                finish();
    ...
    public void konuDersSecimi()
    {
        ...
        ArrayAdapter<String>adapter2=new ArrayAdapter<String >(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,mat1Konular);
        ...
        dersler.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,mat2Konular);
                    konular.setAdapter(adapter2);
                }
                else if(parent.getSelectedItem().toString().equals(derslerList[2]))
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,geoKonular);
                    konular.setAdapter(adapter2);
                }
                else if(parent.getSelectedItem().toString().equals(derslerList[3]))
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,fizikKonular);
                    konular.setAdapter(adapter2);
                }
                else if(parent.getSelectedItem().toString().equals(derslerList[4]))
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,kimyaKonular);
                    konular.setAdapter(adapter2);
                }
                else if(parent.getSelectedItem().toString().equals(derslerList[5]))
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,bioKonular);
                    konular.setAdapter(adapter2);
                }
                else if(parent.getSelectedItem().toString().equals(derslerList[6]))
                {
                    ArrayAdapter<String>adapter2=new ArrayAdapter<String>(ProfilKategorilendirActivity.this,R.layout.support_simple_spinner_dropdown_item,turkceKonular);
                    konular.setAdapter(adapter2);
                }
